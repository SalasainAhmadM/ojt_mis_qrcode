...
<body>
    ...
    <section class="home-section">
        ...
        <div class="content-wrapper">
            ...
            onclick="openEditModal(scheduleData.schedule_id, 
                                    scheduleData.time_in, 
                                    scheduleData.time_out, 
                                    scheduleData.day_type)">
        <i class="fas fa-edit"></i>
    </button>
                        <button class="delete-button" onclick="openDeleteModal('deleteModal')"><i class="fas fa-trash"></i></button>
                        </div>
                    </div>
                </div>
    ...
    <div class="modal-content-date">
        ...
        <form id="editScheduleForm" action="./calendar/update_schedule.php" method="POST">
            ...
            <div class="modal-buttons" style="margin-top: 20px;">
                ...
                <button type="button" class="cancel-btn" onclick="closeEditModal('editScheduleModal')">Cancel</button>
            </div>
        </form>
    </div>
</div>
